...
<div style="text-align: center;">
  <img src="db315a6647c7f14efb3064e5e286e2a2.jpg">
</div>
```
...
table_4 %>%
  ...
  column_spec(5, image = spec_image(
    c("T1_logo.svg.png", "Weibo_Gaming_logo.png", "Bilibili_Gaming_2021_full_allmode.png", "Logo_JD_Gaming.png", "60972b548b70f2cc4f3e8b66_nrg-open-graph.jpg", "Gen.G_logo.png", "KT_Rolster_2021_teamcard_allmode.png", "LNG_Esports_allmode.png", "Logo_DPlus_KIA.png", "Fnaticlogo_square.webp", "G2-Esports-2020-Logo_87bf0678-e67f-4834-8b09-e56137ffaa80.webp"), 80, 70)) %>% 
...
```{=html}
<div style="text-align: center;">
  <img src="t1_trophy.png" style="width: 80%;">
</div>
```
...
img <- readJPEG("7bcd106dc320cdd7ef4e905039ca2881.jpg")
